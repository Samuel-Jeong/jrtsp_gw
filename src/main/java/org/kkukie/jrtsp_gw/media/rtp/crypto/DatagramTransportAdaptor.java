...
public class DatagramTransportAdaptor implements DatagramTransport {
    ...
    /**
     * @param newBuffer this is a single use, disposable buffer for reading data from
     *                  an external source
     */
    ...
    /**
     * @param newBuffer this is a single use, disposable buffer for writing data to an
     *                  external source
     */
