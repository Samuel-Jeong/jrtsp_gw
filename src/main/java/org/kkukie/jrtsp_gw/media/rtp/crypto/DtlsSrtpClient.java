...
import static org.kkukie.jrtsp_gw.media.rtp.crypto.TlsUtils.loadPrivateKeyResource;
    ...
    public TlsAuthentication getAuthentication () throws IOException {
        return new TlsAuthentication() {
            ...
            public TlsCredentials getClientCredentials (CertificateRequest certificateRequest) throws IOException {
                ...
                AsymmetricKeyParameter dtlsPrivateKey = loadPrivateKeyResource(keyResource);
                TlsCertificate dtlsCertChain = TlsUtils.loadCertificateChain(certificateResources);
