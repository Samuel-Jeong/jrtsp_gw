 ...
 * send the hash of the requested tlsCertificate to the responder. This hash is
 * cryptographically bound to the tlsCertificate and serves as evidence that the
 * tlsCertificate is known to the responder (i.e. it has been issued and is present
 * in the directory). Hence, this extension is a means to provide a positive
 * statement of availability as described in T8.[8]. As explained in T13.[1],
 * clients may rely on this information to be able to validate signatures after
 * the expiry of the corresponding tlsCertificate. Hence, clients MUST support this
    ...
    extends ASN1Object
{
     ...
     * @param certificateHash The hash of the whole DER encoding of the tlsCertificate.
     */
