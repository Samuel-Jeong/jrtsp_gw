package org.kkukie.jrtsp_gw.media.bouncycastle.asn1.isismtt.ocsp;
...
/**
 * ISIS-MTT-Optional: The tlsCertificate requested by the client by inserting the
 * RetrieveIfAllowed extension in the request, will be returned in this
 * extension.
 * <p>
 * ISIS-MTT-SigG: The signature act allows publishing certificates only then,
 * when the tlsCertificate owner gives his explicit permission. Accordingly, there
 ...
 * tlsCertificate: RequestedCertificate returned including the requested
 * tlsCertificate
 * <li>b) the responder supports the extension but is NOT allowed to publish
 * the tlsCertificate: RequestedCertificate returned including an empty OCTET
 * STRING
    ...
    implements ASN1Choice
{
     ...
     *
     * @param certificate          Given as TlsCertificate
     */
    ...
    public byte[] getCertificateBytes()
    {
        if (cert != null)
        {
            ...
            {
                throw new IllegalStateException("can't decode tlsCertificate: " + e);
            }
        }
        if (publicKeyCert != null)
        {
