 ...
 * in one tlsCertificate shall match the subject name in the other and vice versa,
 * and the subject public key in one tlsCertificate shall be capable of verifying
 * the digital signature on the other tlsCertificate and vice versa.
 * 
 ...
 *         forward        [0]    TlsCertificate OPTIONAL,
 *         reverse        [1]    TlsCertificate OPTIONAL,
