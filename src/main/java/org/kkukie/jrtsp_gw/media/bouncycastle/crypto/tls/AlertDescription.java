...
public class AlertDescription
{
    ...
    /**
     * A tlsCertificate was corrupt, contained signatures that did not verify correctly, etc.
     */
    public static final short bad_certificate = 42;

    /**
     * A tlsCertificate was of an unsupported type.
     */
    public static final short unsupported_certificate = 43;

    /**
     * A tlsCertificate was revoked by its signer.
     */
    public static final short certificate_revoked = 44;

    /**
     * A tlsCertificate has expired or is not currently valid.
     */
    public static final short certificate_expired = 45;

    /**
     * Some other (unspecified) issue arose in processing the tlsCertificate, rendering it
     * unacceptable.
     */
    ...
    /**
     * A valid tlsCertificate chain or partial chain was received, but the tlsCertificate was not accepted
     * because the CA tlsCertificate could not be located or couldn't be matched with a known, trusted
     * CA. This message is always fatal.
     */
    public static final short unknown_ca = 48;

    /**
     * A valid tlsCertificate was received, but when access control was applied, the sender decided not
    ...
    /**
     * This alert is sent by servers who are unable to retrieve a tlsCertificate chain from the URL
     ...
     * unable to retrieve the tlsCertificate chain, it may send a fatal alert.
     */
    ...
    /**
     * This alert is sent by clients that receive an invalid tlsCertificate status response (see
     * Section 3.6). This message is always fatal.
     */
    public static final short bad_certificate_status_response = 113;

    /**
     * This alert is sent by servers when a tlsCertificate hash does not match a client provided
