...
public class TlsECDHKeyExchange extends AbstractTlsKeyExchange
{
    ...
    public void processClientCertificate(TlsCertificate clientTlsCertificate) throws IOException
    {
        if (keyExchange == KeyExchangeAlgorithm.ECDH_anon)
        {
            throw new TlsFatalAlert(AlertDescription.unexpected_message);
    ...
    public void processClientKeyExchange(InputStream input) throws IOException
    {
        ...
        {
            // For ecdsa_fixed_ecdh and rsa_fixed_ecdh, the key arrived in the client tlsCertificate
            return;
        }
