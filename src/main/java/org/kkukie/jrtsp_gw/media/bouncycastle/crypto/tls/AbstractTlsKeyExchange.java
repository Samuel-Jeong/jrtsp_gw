    ...
    implements TlsKeyExchange
{
        ...
        throws IOException
    {
        ...
        {
            /*
             * RFC 2246 7.4.2. Unless otherwise specified, the signing algorithm for the
             * tlsCertificate must be the same as the algorithm for the tlsCertificate key.
             */
        }
        else
        {
    ...
    public void processClientCertificate(TlsCertificate clientTlsCertificate)
        throws IOException
    {
    }
