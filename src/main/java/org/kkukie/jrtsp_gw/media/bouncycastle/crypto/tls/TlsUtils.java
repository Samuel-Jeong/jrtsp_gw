...
import org.kkukie.jrtsp_gw.media.bouncycastle.asn1.x509.Extensions;
...
import org.kkukie.jrtsp_gw.media.bouncycastle.crypto.digests.*;
...
import org.kkukie.jrtsp_gw.media.bouncycastle.util.Integers;
import org.kkukie.jrtsp_gw.media.bouncycastle.util.Shorts;
...
public class TlsUtils
{
    ...
    static void validateKeyUsage(org.kkukie.jrtsp_gw.media.bouncycastle.asn1.x509.Certificate c, int keyUsageBits)
        throws IOException
    {
    ...
    static short getClientCertificateType(TlsCertificate clientTlsCertificate, TlsCertificate serverTlsCertificate)
        throws IOException
    {
        ...
        org.kkukie.jrtsp_gw.media.bouncycastle.asn1.x509.Certificate x509Cert = clientTlsCertificate.getCertificateAt(0);
        ...
        try
        {
            ...
            /*
             * RFC 5246 7.4.6. Client TlsCertificate
             */

            /*
             * RSA public key; the tlsCertificate MUST allow the key to be used for signing with the
             * signature scheme and hash algorithm that will be employed in the tlsCertificate verify
             * message.
             */
            ...
            /*
             * DSA public key; the tlsCertificate MUST allow the key to be used for signing with the
             * hash algorithm that will be employed in the tlsCertificate verify message.
             */
            ...
            /*
             * ECDSA-capable public key; the tlsCertificate MUST allow the key to be used for signing
             * with the hash algorithm that will be employed in the tlsCertificate verify message; the
