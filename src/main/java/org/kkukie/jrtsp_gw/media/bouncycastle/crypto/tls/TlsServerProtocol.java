    ...
    extends TlsProtocol
{
        ...
        throws IOException
    {
        ...
        case HandshakeType.client_hello:
        {
            ...
            case CS_START:
            {
                ...
                else
                {
                    ...
                    serverTlsCertificate = this.serverCredentials.getCertificate();
                    sendCertificateMessage(serverTlsCertificate);
                }
        ...
        case HandshakeType.client_key_exchange:
        {
            ...
            case CS_CLIENT_SUPPLEMENTAL_DATA:
            {
                ...
                else
                {
                    ...
                    {
                        if (this.peerTlsCertificate == null)
                        {
                            throw new TlsFatalAlert(AlertDescription.unexpected_message);
                        }
                    }
                    ...
                    {
                        notifyClientCertificate(TlsCertificate.EMPTY_CHAIN);
                    }
                }
                // NB: Fall through to next case label
            }
        ...
        case HandshakeType.certificate_verify:
        {
            ...
            {
                /*
                 * RFC 5246 7.4.8 This message is only sent following a client tlsCertificate that has
        ...
        throws IOException
    {
        ...
        {
            /*
             * SSL 3.0 If the server has sent a tlsCertificate request Message, the client must send
             * either the tlsCertificate message or a no_certificate alert.
             */
    ...
    protected void notifyClientCertificate(TlsCertificate clientTlsCertificate)
        throws IOException
    {
        ...
        if (peerTlsCertificate != null)
        {
            throw new TlsFatalAlert(AlertDescription.unexpected_message);
        }

        this.peerTlsCertificate = clientTlsCertificate;
        ...
        else
        {
            ...
            this.clientCertificateType = TlsUtils.getClientCertificateType(clientTlsCertificate,
                this.serverCredentials.getCertificate());

            this.keyExchange.processClientCertificate(clientTlsCertificate);
        }
         ...
         * a fatal alert.
         */
        this.tlsServer.notifyClientCertificate(clientTlsCertificate);
    }
        ...
        throws IOException
    {
        ...
        notifyClientCertificate(clientTlsCertificate);
    }
        ...
        throws IOException
    {
        ...
        try
        {
            ...
            org.kkukie.jrtsp_gw.media.bouncycastle.asn1.x509.Certificate x509Cert = peerTlsCertificate.getCertificateAt(0);
        ...
        throws IOException
    {
        ...
        if (!this.serverExtensions.isEmpty())
        {
            ...
            this.expectSessionTicket = !resumedSession
                && TlsUtils.hasExpectedEmptyExtensionData(serverExtensions, EXT_SessionTicket,
                    AlertDescription.internal_error);
