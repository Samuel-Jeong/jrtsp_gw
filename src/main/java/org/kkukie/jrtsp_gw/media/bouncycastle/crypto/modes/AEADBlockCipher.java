 ...
 * @see org.kkukie.jrtsp_gw.media.bouncycastle.crypto.params.AEADParameters
 */
public interface AEADBlockCipher
{
     ...
     * @throws org.kkukie.jrtsp_gw.media.bouncycastle.crypto.InvalidCipherTextException if the MAC fails to match.
     */
