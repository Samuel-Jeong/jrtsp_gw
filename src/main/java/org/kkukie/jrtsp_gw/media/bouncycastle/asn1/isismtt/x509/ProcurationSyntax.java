package org.kkukie.jrtsp_gw.media.bouncycastle.asn1.isismtt.x509;

import org.kkukie.jrtsp_gw.media.bouncycastle.asn1.*;
import org.kkukie.jrtsp_gw.media.bouncycastle.asn1.x500.DirectoryString;
import org.kkukie.jrtsp_gw.media.bouncycastle.asn1.x509.GeneralName;
import org.kkukie.jrtsp_gw.media.bouncycastle.asn1.x509.IssuerSerial;

import java.util.Enumeration;

/**
 * Attribute to indicate that the tlsCertificate holder may sign in the name of a
 * third person.
 * <p>
 * ISIS-MTT PROFILE: The corresponding ProcurationSyntax contains either the
 * name of the person who is represented (subcomponent thirdPerson) or a
 * reference to his/her base tlsCertificate (in the component signingFor,
    ...
    extends ASN1Object
{
     ...
     * @param certRef            Reference to tlsCertificate of the person who is represented.
     */
