    ...
    extends TlsProtocol
{
        ...
        throws IOException
    {
        ...
        case HandshakeType.certificate:
        {
            ...
            {
                // Parse the TlsCertificate message and send to cipher suite

                this.peerTlsCertificate = TlsCertificate.parse(buf);

                assertEmpty(buf);

                // TODO[RFC 3546] Check whether empty certificates is possible, allowed, or excludes CertificateStatus
                if (this.peerTlsCertificate == null || this.peerTlsCertificate.isEmpty())
                {
                    this.allowCertificateStatus = false;
                }

                this.keyExchange.processServerCertificate(this.peerTlsCertificate);

                this.authentication = tlsClient.getAuthentication();
                this.authentication.notifyServerCertificate(this.peerTlsCertificate);
        ...
        case HandshakeType.server_hello_done:
        {
            ...
            case CS_SERVER_SUPPLEMENTAL_DATA:
            {
                // There was no server tlsCertificate message; check it's OK
            ...
            case CS_CERTIFICATE_REQUEST:
            {
                ...
                else
                {
                    ...
                    if (clientCreds == null)
                    {
                         ...
                         */
                        sendCertificateMessage(TlsCertificate.EMPTY_CHAIN);
                    }
                    else
                    {
...
//                    throw new TlsFatalAlert(AlertDescription.illegal_parameter);
        ...
        if (sessionServerExtensions != null && !sessionServerExtensions.isEmpty())
        {
            ...
            this.expectSessionTicket = !this.resumedSession
                && TlsUtils.hasExpectedEmptyExtensionData(sessionServerExtensions, EXT_SessionTicket,
