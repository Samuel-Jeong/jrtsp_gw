...
import org.kkukie.jrtsp_gw.media.bouncycastle.asn1.DERBitString;
 ...
 * badCertId            (4), -- no tlsCertificate could be found matching the provided criteria
 * badDataFormat        (5),
    ...
    extends DERBitString
{
    ...
    public static final int badCertId            = (1 << 3); // no tlsCertificate could be found matching the provided criteria
