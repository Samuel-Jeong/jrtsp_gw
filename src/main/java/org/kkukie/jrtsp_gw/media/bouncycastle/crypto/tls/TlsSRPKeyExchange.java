...
import org.kkukie.jrtsp_gw.media.bouncycastle.crypto.agreement.srp.SRP6Client;
import org.kkukie.jrtsp_gw.media.bouncycastle.crypto.agreement.srp.SRP6Server;
import org.kkukie.jrtsp_gw.media.bouncycastle.crypto.agreement.srp.SRP6Util;
...
import org.kkukie.jrtsp_gw.media.bouncycastle.util.io.TeeInputStream;
...
public class TlsSRPKeyExchange extends AbstractTlsKeyExchange
{
    ...
    public void processServerCertificate(TlsCertificate serverTlsCertificate) throws IOException
    {
        if (tlsSigner == null)
        {
            throw new TlsFatalAlert(AlertDescription.unexpected_message);
