    ...
    extends AbstractTlsKeyExchange
{
    ...
    {
        /*
         * RFC 2246 7.4.7.2 If the client tlsCertificate already contains a suitable Diffie-Hellman
    ...
    public void processClientKeyExchange(InputStream input) throws IOException
    {
        ...
        {
            // For dss_fixed_dh and rsa_fixed_dh, the key arrived in the client tlsCertificate
            return;
        }
