    ...
    extends ASN1Object
{
    ...
    /**
     * Sets the values of the tlsCertificate (body and signature).
     *
     ...
     *
     * @param obj the Object to extract the tlsCertificate from.
    ...
    /**
     * Gives the body of the tlsCertificate.
     *
     * @return the body.
     */
    ...
    /**
     * @return the type of tlsCertificate (request or profile)
    ...
    /**
     * @return the Authority Reference field of the tlsCertificate
     * @throws IOException
     */
    ...
    /**
     * @return the Holder Reference Field of the tlsCertificate
     * @throws IOException
     */
    ...
    /**
     * @return the bits corresponding to the role intented for the tlsCertificate
    ...
    /**
     * @return the bits corresponding the authorizations contained in the tlsCertificate
     *         See Iso7816CertificateHolderAuthorization static int for values
     * @throws IOException
     */
