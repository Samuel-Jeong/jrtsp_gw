...
import org.kkukie.jrtsp_gw.media.bouncycastle.asn1.x509.AttributeCertificate;
    ...
    implements ASN1Choice
{
     ...
     *
     * @param type the type of the tlsCertificate (used as a tag value).
     * @param otherCert the object representing the tlsCertificate
     */
