    ...
    extends TlsPeer
{
     ...
     * 3.6. TlsCertificate Status Request</i>. If a non-null {@link CertificateStatus} is returned, it
    ...
    /**
     * Called by the protocol handler to report the client tlsCertificate, only if
     ...
     * 
     * @param clientTlsCertificate
     *            the effective client tlsCertificate (may be an empty chain).
     * @throws IOException
     */
    void notifyClientCertificate(TlsCertificate clientTlsCertificate)
        throws IOException;
