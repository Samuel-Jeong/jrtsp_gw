package org.kkukie.jrtsp_gw.media.bouncycastle.asn1.eac;
 ...
 *      // version of the tlsCertificate format. Must be 0 (version 1)
 ...
 *      //associates the public key contained in the tlsCertificate with a unique name
 *      // contains the iso3166-1 alpha2 encoded country code, the
 ...
 *      // the date of the tlsCertificate generation
 *      CertificateEffectiveDate            ASN1ApplicationSpecific,
 *      // the date after wich the tlsCertificate expires
...
{
    ASN1InputStream seq;
    private ASN1ApplicationSpecific certificateProfileIdentifier;// version of the tlsCertificate format. Must be 0 (version 1)
    ...
    private ASN1ApplicationSpecific certificateHolderReference;//associates the public key contained in the tlsCertificate with a unique name
    ...
    private ASN1ApplicationSpecific certificateEffectiveDate;// the date of the tlsCertificate generation
    private ASN1ApplicationSpecific certificateExpirationDate;// the date after wich the tlsCertificate expires
    private int certificateType = 0;// bit field of initialized data. This will tell us if the data are valid.
    private static final int CPI = 0x01;//tlsCertificate Profile Identifier
    private static final int CAR = 0x02;//certification Authority Reference
    private static final int PK = 0x04;//public Key
    private static final int CHR = 0x08;//tlsCertificate Holder Reference
    private static final int CHA = 0x10;//tlsCertificate Holder Authorization
    private static final int CEfD = 0x20;//tlsCertificate Effective Date
    private static final int CExD = 0x40;//tlsCertificate Expiration Date

    public static final int profileType = 0x7f;//Profile type TlsCertificate
    public static final int requestType = 0x0D;// Request type TlsCertificate
     ...
     *
     * @return return the "profile" type tlsCertificate body.
     ...
     *
     * @return return the "request" type tlsCertificate body.
     * @throws IOException if the ASN1ApplicationSpecific cannot be created.
     */
     ...
     *
     * @return return the ASN1Primitive representing the "request" or "profile" type tlsCertificate body.
     */
    ...
    /**
     * gives the type of the tlsCertificate (value should be profileType or requestType if all data are set).
     *
     ...
     *
     * @param obj is the Object to extract the tlsCertificate body from.
    ...
    /**
     * @return the date of the tlsCertificate generation
     */
    ...
    /**
     * set the date of the tlsCertificate generation
     *
     * @param ced ASN1ApplicationSpecific containing the date of the tlsCertificate generation
    ...
    /**
     * @return the date after wich the tlsCertificate expires
     */
        ...
        throws IOException
    {
        ...
        throw new IOException("tlsCertificate Expiration Date not set");
    }

    /**
     * set the date after wich the tlsCertificate expires
     *
     * @param ced ASN1ApplicationSpecific containing the date after wich the tlsCertificate expires
     ...
     * storing sensitive data. This functions returns the TlsCertificate Holder
     * Authorization
     *
        ...
        throws IOException
    {
        ...
        throw new IOException("TlsCertificate Holder Authorisation not set");
    }

    /**
     * set the CertificateHolderAuthorization
     *
     * @param cha the TlsCertificate Holder Authorization
     */
    ...
    /**
     * certificateHolderReference : associates the public key contained in the tlsCertificate with a unique name
     *
    ...
    /**
     * CertificateProfileIdentifier : version of the tlsCertificate format. Must be 0 (version 1)
     *
