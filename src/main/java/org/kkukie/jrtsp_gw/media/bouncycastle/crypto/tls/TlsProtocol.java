...
import org.kkukie.jrtsp_gw.media.bouncycastle.crypto.prng.RandomGenerator;
...
//    private ByteQueue heartbeatQueue = new ByteQueue();
    ...
    protected TlsCertificate peerTlsCertificate = null;
...
//        }
    ...
    protected void sendCertificateMessage(TlsCertificate tlsCertificate)
        throws IOException
    {
        if (tlsCertificate == null)
        {
            tlsCertificate = TlsCertificate.EMPTY_CHAIN;
        }
