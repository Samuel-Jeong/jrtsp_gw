...
package org.kkukie.jrtsp_gw.media.stun;
...
//		this.remoteCandidates = new ArrayList<IceCandidate>(5);
     ...
     * </p>
     *
     * @param componentId The value to be evaluated.
     ...
     *
     * @param candidatesWrapper The list of local candidates
     ...
     *
     * @param candidateWrapper The wrapper that contains the local ICE candidate
     */
     ...
     *
     * @param candidateWrapper The wrapper that contains the local ICE candidate
     * @param sort             Decides whether the candidates list should be ordered after
     *                         insert
     */
