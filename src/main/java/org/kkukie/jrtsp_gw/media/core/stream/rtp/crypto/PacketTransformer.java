...
public interface PacketTransformer {
     ...
     *
     * @param pkt    The packet to be secured
     * @param offset The offset of the packet data
     ...
     * packet back).
     *
     * @param pkt    the packet to be restored
     * @param offset the offset of the packet data
     * @param length the length of data in the packet
