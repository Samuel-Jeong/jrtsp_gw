...
package org.kkukie.jrtsp_gw.media.core.component;


import org.kkukie.jrtsp_gw.media.core.scheduler.PriorityQueueScheduler;
import org.kkukie.jrtsp_gw.media.core.scheduler.Task;
import org.kkukie.jrtsp_gw.media.core.spi.MediaSource;
...
public abstract class AbstractSource extends BaseComponent implements MediaSource {
  ...
  //duration of media stream in nanoseconds
     ...
     * (Non Java-doc.)
     * 
     * @see org.kkukie.jrtsp_gw.media.core.component.AbstractSource#setInitialDelay(long)
     */
     ...
     * (Non Java-doc).
     * 
     * @see org.kkukie.jrtsp_gw.media.core.spi.MediaSource#getBytesTransmitted()
     */
