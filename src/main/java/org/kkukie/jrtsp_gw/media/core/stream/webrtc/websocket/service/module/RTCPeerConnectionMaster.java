...
@Getter
@Setter
public class RTCPeerConnectionMaster {
    ...
    private boolean enableRequisiteFields() {
        ...
        try {
            newFingerPrint = FingerPrintGenerator.getFingerPrint(certPath);
        } catch (Exception e) {
            log.warn("RTCPeerConnectionMaster.getFingerPrint.Exception", e);
            return true;
        }
