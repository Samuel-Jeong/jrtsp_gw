...
package org.kkukie.jrtsp_gw.media.core.stream.rtp.port;
...
/**
 * {@link WebSocketPortManager} that helps to acquire an even port for an RTP channel. The odd port will be reserved for RTCP.
 * 
 * @author yulian oifa
