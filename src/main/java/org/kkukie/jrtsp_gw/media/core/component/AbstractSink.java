...
import org.kkukie.jrtsp_gw.media.core.spi.MediaSink;
...
public abstract class AbstractSink extends BaseComponent implements MediaSink {
     ...
     * 
     * @param frame the new portion of media data.
     */
     ...
     * 
     * @param e failure event identifier.
    ...
    public void perform(Frame frame) {
    	...
    	try {
    		...
    		logger.error("AbstractSink.perform.IOException", e);
    		started = false;
        	failed(e);
    	}
    }    
