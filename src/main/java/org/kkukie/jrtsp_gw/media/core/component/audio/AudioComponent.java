...
import org.kkukie.jrtsp_gw.media.core.concurrent.ConcurrentMap;
import org.kkukie.jrtsp_gw.media.core.spi.format.AudioFormat;
import org.kkukie.jrtsp_gw.media.core.spi.format.FormatFactory;
import org.kkukie.jrtsp_gw.media.core.spi.memory.Frame;
import org.kkukie.jrtsp_gw.media.core.spi.memory.Memory;
...
public class AudioComponent {
	...
	private static final Logger logger = LoggerFactory.getLogger(AudioComponent.class);
	...
	public AudioComponent(int componentId) {
		...
		this.data2 = new byte[PACKET_SIZE];
	...
	public void perform2() {
		...
		while (activeInputs.hasNext()) {
			...
			if (inputFrame != null) {
				try {
					final byte[] dataArray = inputFrame.getData();
					System.arraycopy(dataArray, 0, data2, 0, dataArray.length);
